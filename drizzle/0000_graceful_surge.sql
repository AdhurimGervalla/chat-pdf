...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "workspaces_users" ADD CONSTRAINT "workspaces_users_user_id_users_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "users"("user_id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
