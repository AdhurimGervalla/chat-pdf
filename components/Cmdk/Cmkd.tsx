            ...
            {chats && workspaces &&
                        <Command.Dialog onKeyDown={(e) => {
                            ...
                            <Command.List className='p-5'>
                                {!page && <Overview handeOnSelect={handeOnSelect} 
                                ...
                                {page && page[0] === 'chats' && (
                                    <ChatsList chats={chats} currentChatId={chatId as string} handleDetailView={handleDetailView} />
                                )}
                                ...
                                {page && page[0] === 'newWorkspace' && <NewWorkspace refetchWorkspaces={refetchWorkspaces} reset={reset} />}                
                            </Command.List>
                        </Command.Dialog>
            }
