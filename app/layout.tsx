...
export const metadata: Metadata = {
  title: "workspAIces",
  description:
    "Optimize your interaction with AI by leveraging the context of your own data.",
  abstract:
    "workspAIces is a service that enables you to pose AI questions within the context of your own data.",
};
                ...
                >
                  <head>
                    ...
                    <meta
                      ...
                      content="workspAIces App"
                    />
                    <meta
                      name="description"
                      content="Chat within your own context"
                    />
